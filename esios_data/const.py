...
ESIOS_INDICATOR_INJECTION_PRICE = 1739
ESIOS_INDICATOR_CO2_GEN = 10355
ESIOS_INDICATOR_CO2_FREE_PERC = 10033
ESIOS_INDICARTOR_GAS_COMPENSATION_PRICE = 1900
...
_INDICATOR_IDS: Dict[str, int] = {
    ...
    "INJECTION": ESIOS_INDICATOR_INJECTION_PRICE,
    "CO2_GEN": ESIOS_INDICATOR_CO2_GEN,
    "CO2_FREE": ESIOS_INDICATOR_CO2_FREE_PERC,
    "GAS_COMPENSATION": ESIOS_INDICARTOR_GAS_COMPENSATION_PRICE,
}
...
_INDICATOR_IS_PRICE: Dict[int, bool] = {
    ...
    ESIOS_INDICATOR_INJECTION_PRICE: True,
    ESIOS_INDICATOR_CO2_GEN: False,
    ESIOS_INDICATOR_CO2_FREE_PERC: False,
    ESIOS_INDICARTOR_GAS_COMPENSATION_PRICE: True,
}
_INDICATOR_MIN_DELTA_UPDATE: Dict[int, timedelta] = {
    ESIOS_INDICATOR_PVPC: timedelta(minutes=30),
    ESIOS_INDICATOR_INJECTION_PRICE: timedelta(minutes=30),
    ESIOS_INDICARTOR_GAS_COMPENSATION_PRICE: timedelta(minutes=30),
...
INDICATOR_IS_GEOZONED: Dict[int, bool] = {
    ESIOS_INDICATOR_PVPC: True,
    ESIOS_INDICATOR_INJECTION_PRICE: False,
    ESIOS_INDICARTOR_GAS_COMPENSATION_PRICE: True,
    ESIOS_INDICATOR_CO2_GEN: False,
    ESIOS_INDICATOR_CO2_FREE_PERC: False,
}
